...
function ProyectosTom() {
  ...
  {Link:"https://gestionat-9iia.vercel.app/", image:"Gestionat.png",  titulo:"Gestionat", descripcion:"Aplicacion para administracion de negocios", tipo:"Gestion de negocio"  },
 ...
 <a href={p.Link}>
 <div style={{"--i":index+1}} className={proyecto?`seccion-proyectos-tarjetas `:"seccion-proyectos-tarjetas false"}>
